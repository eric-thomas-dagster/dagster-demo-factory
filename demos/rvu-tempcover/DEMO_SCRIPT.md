...
3. Materialize everything. Say: *"Every asset here is real — the dbt layer
   is running actual dbt Core against real rows, with real tests. Nothing
   in this graph is hardcoded to pass."*
...
lineage — works identically the day this points at your real BigQuery
project instead of a local DuckDB file. That's the whole point of building
it this way: nothing about the orchestration logic changes when the
credentials do."*
