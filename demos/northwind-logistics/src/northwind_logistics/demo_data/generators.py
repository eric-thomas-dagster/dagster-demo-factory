...
CUSTOMER_NAME_STEMS = [
    "Meridian", "Prairie", "Cascade", "Summit", "Harborline", "Ironwood",
    "Bluepeak", "Redwood", "Northfield", "Lakeshore", "Copperline", "Fairview",
    "Granite", "Silverton", "Crestwood", "Amberfield", "Stonebridge", "Westgate",
    "Clearwater", "Eastport", "Millbrook", "Ashford", "Riverdale", "Highpoint",
]
...
_LANE_MILES = {
    ("ORD", "DFW"): 800, ("ORD", "ATL"): 590, ("LAX", "PHX"): 370, ("LAX", "SEA"): 1130,
    ("JFK", "BOS"): 215, ("JFK", "MIA"): 1280, ("DFW", "DEN"): 780, ("ATL", "MIA"): 660,
    ("SEA", "DEN"): 1020, ("PHX", "DFW"): 890,
}
...
def generate_shipment_events_frame(event_date: str, seed: int) -> pd.DataFrame:
    ...
    for i in range(count):
        ...
        miles = _LANE_MILES[(origin, destination)] + int(rng.integers(-15, 16))
        rows.append(
            {
