"""Named AutomationCondition for this defs.yaml.
...
def recompute_after_upstream_and_checks_pass():
    ...
    `staged_readings_completeness` genuinely stops automatic propagation
    into staging, not just the one run that surfaced it.
    """
