...
on every process that imports `neighborhood_intelligence_taxi.definitions`
...
from neighborhood_intelligence_taxi.demo_data.warehouse import demo_duckdb_path
